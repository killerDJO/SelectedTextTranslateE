<template>
  <data-table :configuration="tableConfiguration" :records="historyRecords" class="results" @update-columns-configuration="updateColumnsConfiguration" @record-click="translateHistoryRecord">
