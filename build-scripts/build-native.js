...
const nativeExtensionsPath = 'packages/main/src/native-extensions';
...
function runNodeGyp() {
  ...
  const electronHeadersUrl = 'https://electronjs.org/headers';

  const gypProcess = spawn(
    'npx',
    [
      'node-gyp',
      'rebuild',
      ...
      `--directory=${nativeExtensionsPath}`
    ],
    { shell: true }
  );
